...
/**
 * Provides the local service interface for MailTemplate. Methods of this
...
public interface MailTemplateLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link MailTemplateLocalServiceUtil} to access the mail template local service. Add custom service methods to <code>com.ted.mailing.service.impl.MailTemplateLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	public MailTemplate addMailTemplate(
	...
	public MailTemplate createMailTemplate(long templateId);
	...
	public MailTemplate deleteMailTemplate(long templateId)
		throws PortalException;
	...
	public void deleteTemplate(MailTemplate template) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public MailTemplate fetchMailTemplate(long templateId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public MailTemplate fetchMailTemplateByUuidAndGroupId(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public MailTemplate getMailTemplate(long templateId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public MailTemplate getMailTemplateByUuidAndGroupId(
			String uuid, long groupId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<MailTemplate> getMailTemplatesByUuidAndCompanyId(
	...
	public MailTemplate updateMailTemplate(
	...
	public MailTemplate updateStatus(long userId, long templateId, int status)
		throws PortalException;
